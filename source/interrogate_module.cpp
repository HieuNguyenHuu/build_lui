...
extern const struct LibraryDef lui_moddef;
extern void Dtool_lui_RegisterTypes();
extern void Dtool_lui_BuildInstants(PyObject *module);

#if PY_MAJOR_VERSION >= 3
extern "C" EXPORT_CLASS PyObject *PyInit_lui();
#else
extern "C" EXPORT_CLASS void initlui();
#endif
...
PyObject *PyInit_lui() {
  ...
  Dtool_lui_RegisterTypes();

  const LibraryDef *defs[] = {&lui_moddef, nullptr};

  PyObject *module = Dtool_PyModuleInitHelper(defs, &py_lui_module);
  if (module != nullptr) {
